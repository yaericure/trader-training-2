    ...
    <div className="flex min-w-0 flex-1">
      <main className="min-w-0 flex-1 px-5 py-8 sm:px-8 lg:px-12">
        ...
        <div className="mb-8">
          ...
          <div className="mt-4 h-1.5 w-36 rounded-full bg-gradient-to-r from-rose-600 via-rose-400 to-rose-200 dark:from-rose-400 dark:via-rose-500 dark:to-rose-900" />
        </div>
        ...
        <footer className="mt-10 pb-4 text-xs leading-relaxed text-zinc-400">
          本站為《頂尖操盤手的養成計畫2:交易王者的心智修練》(約翰・派伯 John Piper 著,方言文化出版)的教學導讀筆記,內容為重點整理與延伸解說,並非原書全文。完整內容請支持正版書籍。
        </footer>
      </main>
